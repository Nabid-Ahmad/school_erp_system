                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-4 text-right pr-2">
                                        <form action="{{ route('salaries.destroy', $salary) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white border border-rose-200/60 px-2.5 py-1.5 rounded-lg text-xs font-bold inline-flex items-center gap-1.5 transition-all shadow-xs" onclick="return confirm('Delete this salary payment and its expense record?')">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-16 text-center">
                                        ...
                                        <p class="font-black text-gray-800">No payments recorded yet</p>
                                        <p class="text-xs text-gray-400 font-bold mt-1">Use the form above to pay a teacher's salary.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
