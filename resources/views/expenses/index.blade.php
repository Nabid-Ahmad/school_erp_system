                            ...
                            <tr class="border-b hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="flex justify-end items-center gap-2">
                                        <a href="{{ route('expenses.edit', $expense) }}" class="bg-indigo-50 text-indigo-600 hover:bg-indigo-600 hover:text-white border border-indigo-200/60 px-2.5 py-1.5 rounded-lg text-xs font-bold inline-flex items-center gap-1.5 transition-all shadow-xs">
