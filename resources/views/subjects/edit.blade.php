                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('subjects.update', $subject) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" value="{{ old('name', $subject->name) }}" required>
                            @error('name')
